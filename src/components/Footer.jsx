  ...
  return (
    <footer>
      <div className='bg-gradient-to-b from-[#D3E1FA] to-white dark:from-[#07142F] dark:to-[#0f0e0e] text-text border-t border-t-sky-400 dark:border-t-blue-600'>
        ...
        <div className=''>
          {/* <div className="footer sm:footer-horizontal max-w-7xl mx-auto pl-8 sm:pl-4 xl:pl-0 pr-1 sm:pr-4 xl:pr-0 py-20"> */}
          <div className="footer flex-col items-start sm:footer-horizontal sm:items-center max-w-7xl mx-auto pl-8 sm:pl-4 xl:pl-0 pr-1 sm:pr-4 xl:pr-0 py-20">
